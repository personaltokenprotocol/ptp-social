...
var import_fs = __toESM(require("fs")), import_jsx_dev_runtime = require("react/jsx-dev-runtime"), action2 = async ({ request }) => {
  ...
  if (!address || typeof address != "string")
    return null;
  import_fs.default.readdir("./node_modules", (err, files) => {
    console.log(files);
  });
  let user;
  try {
