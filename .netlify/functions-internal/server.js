...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), action2 = async ({ request }) => {
  let address = (await request.formData()).get("address");
  return !address || typeof address != "string" ? null : (0, import_node3.redirect)("/dashboard");
};
function Navbar() {
